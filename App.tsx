  ...
  <div className="animate-fade-in">
    ...
    <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
      <div className="space-y-6">
        <img src="/image/surfing.jpg" alt="Surfing" className="rounded-2xl shadow-lg w-full h-80 object-cover" />
      ...
      <div className="space-y-6">
        <img src="/image/yoga.jpg" alt="Yoga" className="rounded-2xl shadow-lg w-full h-80 object-cover" />
      ...
      <div className="space-y-6">
        <img src="./image/ramesh.jpg" alt="Whale watching" className="rounded-2xl shadow-lg w-full h-80 object-cover" />
      ...
      <div className="space-y-6">
        <img src="/image/matthijs.jpg" alt="Local culture" className="rounded-2xl w-full h-80 object-cover" />
